...
#define MMA8451_REG_De_Count      0x12
#define MMA8451_REG_MT_CFG        0x15
#define MMA8451_REG_MT_SRC        0x16
#define MMA8451_REG_MT_THS        0x17
#define MMA8451_REG_MT_COUNT      0x18 
...
int1 begin_MMA8451()
{
   ...
   while (readRegister8_MMA8451(MMA8451_REG_CTRL_REG2) & 0x40);               // Comprobamos cuando el bt de reset es 0 para seguir.
          
   writeRegister8_MMA8451(MMA8451_REG_XYZ_DATA_CFG, MMA8451_RANGE_4_G);       // enable 4G range FS1=0 FS0=1; disable High-pass
  
   writeRegister8_MMA8451(MMA8451_REG_MT_CFG,0xF8);                           // ELE = 1, OAE = 1, ZEFE=1, YEFE=1, XEFE=1
   
   writeRegister8_MMA8451(MMA8451_REG_MT_THS,0xA0);                           // DBCNTM=1 ; THS=32*0.063g=2g
  
   writeRegister8_MMA8451(MMA8451_REG_MT_COUNT,0x0F);                         // count=16*1.25=20mSg Tiempo de overaceleration
  
   writeRegister8_MMA8451(MMA8451_REG_CTRL_REG2, 0x02);                       // High res MODS1=1 MODS0=0

   writeRegister8_MMA8451(MMA8451_REG_CTRL_REG4, 0x04);                       // HABILITAMOS INTERRUPCION DE DATo Motion
   
   writeRegister8_MMA8451(MMA8451_REG_CTRL_REG5, 0x04);                       // Direccionamos interrupcion de dato listo al pin INT1 y Motion a INT2

   writeRegister8_MMA8451(MMA8451_REG_PL_CFG, 0x40);                          // Habilita la conf de deteccion de orientacion.

   writeRegister8_MMA8451(MMA8451_REG_CTRL_REG1, 0x01 | 0x04);                // Activate at max rate, low noise mode
