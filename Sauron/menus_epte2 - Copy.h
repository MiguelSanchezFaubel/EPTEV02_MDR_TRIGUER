...
#define NIVEL   12   // Define la separaciÃ³n entre lineas
...
int8 menu_11();   // IlumninaciÃ³n
int8 menu_12();   // Pito (SeÃ±al acÃºstica)
int8 menu_13();   // Version SW/HW
int8 menu_14();   // Cargar valores de memoria
int8 menu_15();     // Contraste pantalla


//   GalvÃ¡nica + microcorrientes
int8 menu_21();   // Nivel de carga elÃ©ctrica
...
// TERAPIAS
int8 menu_120();  // NÃºmero de repeticiones
int8 menu_130();  // NÃºmero de repeticiones
int8 menu_140();  // Menú tratamiento electroestimulación
int8 menu_180();  // Menú tratamiento SMP

int8 menu_200();  // NÃºmero de repeticiones
int8 menu_201();  // NÃºmero de repeticiones
int8 menu_202();
int8 menu_203();
int8 menu_204();
int8 menu_205();
